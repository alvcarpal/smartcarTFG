	                              ...
	                              <h5>Introduzca una matrícula válida: 
	                               ...
	                               <div class="row">
	                                   ...
	                                   <div class="col-md-6">
	                                    ...
	                                    <div class="col-md-12"> <input type="hidden" name="txtipo" value="<%=tipo%>" /> </div>
	                                   <div class="col-md-12"> <input class="btn btn-success btn-send pt-2 btn-block" type="submit" name="accion" value="Solicitar"> </div>
	                               </div>
